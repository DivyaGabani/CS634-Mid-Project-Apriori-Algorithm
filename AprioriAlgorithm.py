import itertools
#This function creates First Candidate set for selected dataset
...
#This function takes "First Candidate set" as input and create "Frequent item set".
#At the end, the function called "generateCandidatSets" takes the output of the "generateFrequentItemSet" function as input.
...
#This function takes "Frequent item set" as input and creates another "Candidate set".
...
#This function takes all the frequent sets generated by above function as input and generates Association Rules
...
#Taking inputs from user for dataset and for minimum SUpport and Minimum Confidence in percentage
...
print("6. CustomData")
print("\n")
print("Select Any Dataset From Above:")
fileNameInput = input(" ")
minimumSupport = input('Enter minimum Support (Any Number From 1-100): ')
minimumConfidence = input('Enter minimum Confidence (Any Number From 1-100): ')
print("\n") 
fileName = ""
...
if len(AprioriOutput) == 0:
    print("There are no association rules for given support and confidence.")
else:
